...
export const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FBFBFD] dark:bg-[#111318] text-[#1D1D1F] dark:text-[#F5F5F7] pt-28 pb-20 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <motion.div 
          ...
          className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white/80 dark:bg-[#1E2028]/80 backdrop-blur-xl p-6 rounded-3xl border border-black/5 dark:border-white/10 shadow-sm"
        >
          <div className="flex items-center gap-4">
            <div className="relative p-3 rounded-2xl bg-gradient-to-tr from-[#86B3F0] via-[#B896DF] to-[#FA7DA8] text-white shadow-md">
              ...
              <span className="absolute -top-1 -right-1 w-3.5 h-3.5 bg-emerald-400 border-2 border-white dark:border-[#1E2028] rounded-full animate-ping" />
            </div>
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                ...
                <span className="font-bold text-emerald-600 dark:text-emerald-400">{data.liveOnlineUsers}</span>
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="p-2 text-xs font-medium rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all shadow-sm"
            ...
            <button
              onClick={handleReset}
              className="p-2 text-xs font-medium rounded-xl bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900/50 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/50 transition-all shadow-sm"
              ...
              >
                ...
                {isActive && (
                  <motion.div 
                    ...
                    className="absolute inset-0 rounded-xl border border-black/10 dark:border-white/20 pointer-events-none" 
                  />
                )}
              </button>
            );
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          ...
          <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }} className="bg-white dark:bg-[#1E2028] p-6 rounded-3xl border border-black/5 dark:border-white/10 shadow-sm hover:shadow-md transition-all relative overflow-hidden group">
          ...
          <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.05 }} className="bg-white dark:bg-[#1E2028] p-6 rounded-3xl border border-black/5 dark:border-white/10 shadow-sm hover:shadow-md transition-all relative overflow-hidden group">
          ...
          {/* Card 3: Live Online */}
          <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.1 }} className="bg-white dark:bg-[#1E2028] p-6 rounded-3xl border border-black/5 dark:border-white/10 shadow-sm hover:shadow-md transition-all relative overflow-hidden group">
          ...
          <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3, delay: 0.15 }} className="bg-white dark:bg-[#1E2028] p-6 rounded-3xl border border-black/5 dark:border-white/10 shadow-sm hover:shadow-md transition-all relative overflow-hidden group">
        ...
        <AnimatePresence mode="wait">
          {activeTab === 'overview' && (
            ...
            >
              ...
              <div className="bg-white dark:bg-[#1E2028] p-6 sm:p-8 rounded-3xl border border-black/5 dark:border-white/10 shadow-sm space-y-6">
                ...
                {/* Animated Bars */}
                <div className="h-64 flex items-end justify-between gap-1 sm:gap-2 pt-6 border-b border-gray-100 dark:border-gray-800">
                  {data.dailyStats.map((day, idx) => {
                    ...
                    return (
                      <div key={day.date} className="flex-1 flex flex-col items-center gap-1 group relative">
                        {/* Hover Tooltip */}
                        <div className="absolute -top-12 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-all pointer-events-none bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-[10px] py-1 px-2.5 rounded-lg shadow-lg whitespace-nowrap z-20 font-medium">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white dark:bg-[#1E2028] p-6 rounded-3xl border border-black/5 dark:border-white/10 shadow-sm space-y-4">
                  <h3 className="text-lg font-bold">
                ...
                <div className="bg-white dark:bg-[#1E2028] p-6 rounded-3xl border border-black/5 dark:border-white/10 shadow-sm space-y-4 flex flex-col justify-between">
                  <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-4 border-t border-gray-100 dark:border-gray-800">
                    <div className="p-3.5 rounded-2xl bg-gray-50 dark:bg-gray-800/50">
                      ...
                      <p className="text-sm font-bold text-emerald-500">0.00% (Client Side)</p>
                    </div>
                    <div className="p-3.5 rounded-2xl bg-gray-50 dark:bg-gray-800/50">
                      <span className="text-[10px] text-gray-400 uppercase font-semibold">
                        {isEnglish ? 'Latency' : 'Gecikme'}
                      </span>
                      <p className="text-sm font-bold text-blue-500">&lt; 1ms (Instant)</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {activeTab === 'tools' && (
            ...
            >
              {Object.entries(data.toolUsageBreakdown).map(([toolName, count]) => (
                <div key={toolName} className="bg-white dark:bg-[#1E2028] p-6 rounded-3xl border border-black/5 dark:border-white/10 shadow-sm space-y-4 hover:border-blue-500/30 transition-all">
                  <div className="flex items-center justify-between">
                    <div className="p-3 rounded-2xl bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400">
                      <Cpu className="w-5 h-5" />
                    </div>
                    <span className="px-2.5 py-1 rounded-full bg-gray-100 dark:bg-gray-800 text-[11px] font-semibold">
                      {count} {isEnglish ? 'uses' : 'Kullanım'}
                    </span>
                  </div>
                  <div>
                    <h4 className="font-bold text-base">{toolName}</h4>
                  ...
                  <div className="pt-2 flex items-center justify-between text-xs text-gray-400 border-t border-gray-100 dark:border-gray-800">
                    <span>{isEnglish ? 'Status: Active' : 'Durum: Aktif'}</span>
                    <span className="text-emerald-500 font-semibold">{isEnglish ? 'Healthy' : 'Sağlıklı'}</span>
                  </div>
                </div>
              ))}
            </motion.div>
          ...
          {activeTab === 'live' && (
            <motion.div 
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -15 }}
              className="bg-white dark:bg-[#1E2028] p-6 rounded-3xl border border-black/5 dark:border-white/10 shadow-sm space-y-4"
            >
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-lg font-bold">
                ...
                <span className="px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-950/40 text-blue-600 dark:text-blue-400 text-xs font-semibold flex items-center gap-1.5">
              ...
              <div className="space-y-3 pt-2">
                {data.recentLogs.length === 0 ? (
                  ...
                  data.recentLogs.map((evt) => (
                    <div key={evt.id} className="p-3.5 rounded-2xl bg-gray-50 dark:bg-gray-800/40 flex items-center justify-between text-xs hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                ...
                <div className="space-y-4 pt-2">
                  <div className="flex items-center justify-between p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/40">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-semibold">Masaüstü (Desktop)</span>
                    </div>
                    <span className="text-sm font-bold">%{data.deviceBreakdown.desktop}</span>
                  </div>
                  <div className="flex items-center justify-between p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/40">
                    <div className="flex items-center gap-3">
                      <Smartphone className="w-5 h-5 text-purple-500" />
                      <span className="text-sm font-semibold">Mobil (Mobile)</span>
                    </div>
                    <span className="text-sm font-bold">%{data.deviceBreakdown.mobile}</span>
                  </div>
                  <div className="flex items-center justify-between p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/40">
                    <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-bold">%{data.deviceBreakdown.tablet}</span>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4 pt-2">
                  <div className="flex items-center justify-between p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/40">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-semibold">Google Chrome / Chromium</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/40">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-semibold">Safari & iOS WebKit</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/40">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-semibold">Firefox & Diğerleri</span>
                    </div>
